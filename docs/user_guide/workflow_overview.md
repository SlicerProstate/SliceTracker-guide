...
Note that the **preparation phase is optional**, although it will typically be necessary. In the situations when pre-procedural imaging data is not available, it is possible to place the targets directly on the intra-procedural images and track those through the course of the procedure.
