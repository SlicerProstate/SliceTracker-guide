...
Note that the preparation phase is optional. In the situations when pre-procedural imaging data is not available, it is possible to place the targets directly on the intra-procedural imagess and track those through the course of the procedure.
